...
require 'src/states/game/LevelState'
...
require 'src/states/game/PokeBallState'
require 'src/states/game/SwapForfeitState'
...
gTextures = {
    ...
    ['masterball'] = love.graphics.newImage('graphics/masterball.png'),
